...
class ReinstatementAmortizationReportWizard(models.TransientModel):
    _name = 'reinstatement.amortization.report.wizard'
    _description = 'Reinstatement Amortization Report Wizard'
    ...
    def action_generate_report(self):
        ...
        return self.env.ref('l10n_ao_account_asset.reinstatement_amortization_report').report_action(self, data=context)

    def action_generate_report_pdf(self):
        context = self._get_wizard_context()
        return self.env.ref('l10n_ao_account_asset.reinstatement_amortization_report_pdf').report_action(self, data=context)
