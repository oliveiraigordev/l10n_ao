...
class WizardSupplierRetentionMap(models.TransientModel):
    _name = "wizard.supplier.retention.map"
    _description = "Supplier Wizard Retention Map"
    ...
    def default_get(self, fields_list):
        res = super(WizardSupplierRetentionMap, self).default_get(fields_list)
    ...
    def print_report(self):
        ...
        return self.env.ref("l10n_ao.report_action_supplier_retention_map").report_action(
            move_ids
        )
    ...
    def print_report_xlsx(self):
        ...
        self.url_download = self.env[
            'report.supplier.retention.map.xlsx'
            ]._get_retention_supplier_map_report_values(self, report_file, data=data)
        return {
    ...
    def action_download_supplier_retention_map_file(self):
        return self.supplier_retention_map_file(self.url_download)

    def supplier_retention_map_file(self, url_download):
