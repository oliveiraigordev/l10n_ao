...
class ReportRetentionMap(models.AbstractModel):
    _name = 'report.supplier.retention.map.xlsx'
    _description = 'Mapa de Retenção de Fornecedores'
    ...
    def _get_retention_supplier_map_report_values(self, docids, report_file, data=None):
    ...
    #         worksheet.write_string('N12', "IMPOSTO RETIDO", value_style)
        ...
        def create_temp_xlsx_file(period, docs):
            ...
            file[-1] = f"Mapa_de_retenção_fornecedores_{period}.xls"
