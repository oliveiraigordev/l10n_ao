SAFT_FILE_XSD = """﻿<?xml version="1.0" encoding="utf-8" ?>
<xs:schema xmlns:doc="urn:schemas-basda-org:schema-extensions:documentation"
  ...
  <xs:annotation>
    <xs:documentation>
      ...
      <doc:ModificationDate>2024-10-16</doc:ModificationDate>
    </xs:documentation>
  </xs:annotation>
  ...
  <xs:complexType name="References">
    <xs:annotation>
      <xs:documentation>
        Referências a facturas nos documentos rectificativos destas. 
        Existindo a necessidade de efectuar mais do que uma referência, esta estrutura poderá ser gerada tantas vezes quantas as necessárias. 
        O preenchimento é obrigatório, quando o campo 4.1.4.8. for preenchido com “NC” – Nota de crédito
      </xs:documentation>
    </xs:annotation>
    <xs:sequence>
      <xs:element minOccurs="0" ref="Reference">
        <xs:annotation>
          <xs:documentation>
            Referência à factura, através de identificação única da mesma, nos sistemas em que exista. 
  ...
  <!-- Estrutura de referencias a outros documentos em PurchaseInvoices -->
  <xs:complexType name="PurchaseReferences">
    <xs:annotation>
      <xs:documentation>
        Referências a facturas nos documentos rectificativos destas. 
        Existindo a necessidade de efectuar mais do que uma referência, esta estrutura poderá ser gerada tantas vezes quantas as necessárias. 
    ...
    <xs:sequence>
      ...
      <xs:element minOccurs="0" ref="InvoiceDate" />
    </xs:sequence>
  </xs:complexType>
  ...
  <xs:complexType name="WithholdingTax">
    ...
    <xs:sequence>
      <xs:element minOccurs="1" ref="WithholdingTaxType" />
      <xs:element minOccurs="0" name="WithholdingTaxDescription" type="SAFAOtextTypeMandatoryMax60Car">
        <xs:annotation>
          <xs:documentation>
            Deve ser indicado o normativo legal aplicável ou a percentagem de imposto aplicável.
          </xs:documentation>
        </xs:annotation>
      </xs:element>
  ...
  <xs:element name="AddressDetail" type="SAFAOtextTypeMandatoryMax250Car">
    <xs:annotation>
      <xs:documentation>
        Endereço detalhado. Deve incluir o nome da rua, número da porta e andar, se aplicável. 
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="ARCNo" type="SAFAOtextTypeMandatoryMax21Car">
    <xs:annotation>
      <xs:documentation>
        Código de referência administrativo ou D.U
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="BillingAddress" type="AddressStructure">
    <xs:annotation>
      <xs:documentation>
        ...
        Corresponde ao endereço da sede ou do estabelecimento estável em território nacional.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="BusinessName" type="SAFAOtextTypeMandatoryMax60Car">
    <xs:annotation>
      <xs:documentation>
        Designação social do sujeito passivo.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="ClosingCreditBalance" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Saldo de encerramento da conta a crédito do plano de contas. O saldo de encerramento a crédito será o do fim do período de tributação ou a data de geração, se anterior.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="ClosingDebitBalance" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Saldo de encerramento da conta a débito do plano de contas. O saldo de encerramento a débito será o do fim do período de tributação ou a data de geração, se anterior.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="CustomerID" type="SAFAOtextTypeMandatoryMax30Car">
    <xs:annotation>
      <xs:documentation>
        ...
        Na lista de clientes não pode existir mais do que um registo com o mesmo CustomerID. Para o caso de consumidores finais, deve ser criado um cliente genérico com a designação "Consumidor final".
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="CustomerTaxID" type="SAFAOtextTypeMandatoryMax30Car">
    <xs:annotation>
      <xs:documentation>
        ...
        Deve ser indicado sem o prefixo do país. O cliente genérico, correspondente ao designado ""Consumidor final"", deve ser identificado com o NIF "999999999".
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="DateCreated" type="SAFAODateSpan">
    <xs:annotation>
      <xs:documentation>
        Data de criação do ficheiro XML do SAF-T (AO).
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="DebitAmount" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Valor da linha, sem impostos, dos documentos a débito. 
        Este valor é deduzido dos descontos de linha e cabeçalho.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="DeductibleAmount" type="SAFMonetaryType2DecimalPlaces" />
  ...
  <xs:element name="IECAmount" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Montante do imposto especial de consumo da linha
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="InvoiceStatusDate" type="SAFdateTimeType">
    <xs:annotation>
      <xs:documentation>
        Data e hora do estado actual do documento
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="LineNumber" type="xs:nonNegativeInteger">
    <xs:annotation>
      <xs:documentation>
        Número de linha. As linhas devem ser exportadas pela mesma ordem em que se encontram no documento original.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="LocationID" type="SAFAOtextTypeMandatoryMax30Car">
    <xs:annotation>
      <xs:documentation>
        Localização dos bens no armazém de destino
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="NumberOfEntries" type="xs:nonNegativeInteger">
    <xs:annotation>
      <xs:documentation>
        GeneralLedgerEntries: Número de registo de movimentos contabilísticos
        SalesInvoices, WorkingDocuments, Payments, PurchaseInvoices: Número total de documentos
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="OpeningCreditBalance" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Saldo de abertura a crédito da conta do plano de contas. O saldo de abertura a crédito será sempre o do início do período de tributação.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="OpeningDebitBalance" type="SAFmonetaryType">
    <xs:annotation>
      <xs:documentation>
        Saldo de abertura a débito da conta do plano de contas. O saldo de abertura a débito será sempre o do início do período de tributação.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="ProductCode" type="SAFAOtextTypeMandatoryMax60Car">
    <xs:annotation>
      ...
      "I" - Impostos, taxas e encargos parafiscais – excepto IVA e IS que deverão ser reflectidos TaxTable) e Impostos Especiais de Consumo, que deverão ser preenchidos com o código "E".
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="ProductCompanyTaxID" type="SAFAOtextTypeMandatoryMax20Car">
    <xs:annotation>
      <xs:documentation>
        Identificação fiscal da entidade produtora do software
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="ProductNumberCode" type="SAFAOtextTypeMandatoryMax60Car">
    <xs:annotation>
      <xs:documentation>
        Código do produto.
        Deve ser usado o código EAN do produto.
        Quando este não existir, preencher com o valor do elemento ProductCode.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="RecordID" type="SAFAOtextTypeMandatoryMax30Car">
    <xs:annotation>
      <xs:documentation>
        Identificador do registo de linha
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="SoftwareValidationNumber" type="ns:SAFAOtextValidationNumber">
    <xs:annotation>
      <xs:documentation>
        Número de validação atribuído ao software
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="StartDate" type="SAFAODateSpan">
    <xs:annotation>
      <xs:documentation>
        Data de início do período do ficheiro
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="SystemEntryDate" type="SAFdateTimeType">
    <xs:annotation>
      <xs:documentation>
        Timestamp a que corresponde a data de registo do documento
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="TaxPointDate" type="SAFdateType">
    <xs:annotation>
      <xs:documentation>
        Data de envio da mercadoria ou prestação do serviço. Deve coincidir com a data precisa do envio da mercadoria ou da prestação do serviço, o que por vezes pode não coincidir com a data do documento.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="TransactionDate" type="SAFdateType">
    <xs:annotation>
      <xs:documentation>
        Data do documento. Para recibos de pagamento corresponde à data do recibo.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  <xs:element name="TransactionID" type="SAFAOTransactionID">
    <xs:annotation>
      <xs:documentation>
        ...
        Deve ser construída de forma a ser única e a corresponder ao número de documento contabilístico, que é utilizado para detectar o documento físico no arquivo, pelo que, deve resultar de uma relação, separada por espaços, entre os seguintes valores: data do documento, identificador do diário e número de arquivo do documento (Transaction Date, Journal ID e Doc Archival Number).
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="WarehouseID" type="SAFAOtextTypeMandatoryMax50Car">
    <xs:annotation>
      <xs:documentation>
        Identificador do armazém de destino
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name="AccountID">
    <xs:annotation>
      <xs:documentation>
        Código da conta
        Deve ser indicada a respectiva conta-corrente do cliente no plano de contas da contabilidade, caso esteja definida. Caso contrário deve ser preenchido com a designação "Desconhecido".
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:string">
  ...
  <xs:element name="AuditFileVersion">
    <xs:annotation>
      <xs:documentation>
        Versão a utilizar do esquema XML
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:string">
  ...
  <!-- Estrutura da tipologia de destino da DP de IVA -->
  <xs:element name="DeductibleTaxType">
    <xs:annotation>
      <xs:documentation>
    ...
    <xs:annotation>
      <xs:documentation>
        Esta identificação é composta sequencialmente pelos seguintes elementos: 
          Tipo de documento (MovementType), um espaço, o código interno do tipo de documento atribuído pela aplicação o identificador da série do documento, uma barra (/) e o número sequencial desse documento dentro dessa série. 
  ...
  <xs:element name="FiscalYear">
    <xs:annotation>
      <xs:documentation>
        Ano fiscal. Utilizar as regras do Código do II, no caso de períodos contabilísticos coincidentes com o ano civíl.
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:integer">
    ...
    <xs:annotation>
      <xs:documentation>
        Esta identificação é composta sequencialmente pelos seguintes elementos: 
          ...
          o código interno do tipo de documento atribuído pela aplicação o identificador da série do documento, 
  ...
  <xs:element name="PaymentRefNo">
    <xs:annotation>
      <xs:documentation>
        Esta identificação é composta sequencialmente pelos seguintes elementos: 
        Tipo de documento (PaymentType), um espaço, o código interno do tipo de documento atribuído pela aplicação o identificador e a série do documento, uma barra (/) e o número sequencial desse documento dentro dessa série. 
        Não podem existir registos com a mesma identificação. 
        Não pode ser utilizado o mesmo código interno de tipo de documento em diferentes tipos de documentos.
      </xs:documentation>
    </xs:annotation>
  ...
  <xs:simpleType name="PaymentTaxCode">
    ...
    <xs:restriction base="xs:string">
      <xs:pattern value="RED|INT|NOR|ISE|OUT|([0-9.])*|NA|NS" />
      <xs:minLength value="1" />
  ...
  <xs:element name="PurchaseType">
    <xs:annotation>
      <xs:documentation>
        ...
        O recibo somente deve ser preenchido por contribuintes enquadrado no regime de caixa 
          “RC” - Recibo;
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:string">
        ...
        <xs:enumeration value="NC" />
        <!-- Apenas para contribuintes enquadrado no regime de caixa -->
  ...
  <xs:element name="SelfBillingIndicator">
    <xs:annotation>
      <xs:documentation>
        ...
        Deve ser preenchido com «1» se respeitar autofaturação, com «0» (zero) no caso contrário.
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:integer">
  ...
  <xs:element name="TaxCountryRegion">
    <xs:annotation>
      <xs:documentation>
        País do imposto
        No caso da província de Cabinda:
        "AO-CAB" - Espaço Fiscal da Região de Cabinda.
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:string">
  ...
  <xs:element name="ThirdPartiesBillingIndicator">
    <xs:annotation>
      <xs:documentation>
        Indicador de regime de IVA de Caixa
        Deve ser preenchido com:
        "0" - Se não cumprir com nenhuma condição;
        "1" - se o documento for emitido em nome e por conta de terceiros;
        "2" - se respeitar ao regime de IVA Cativo;
        "3" - se cumprir com as condições 1 e 2 em simultâneo.
      </xs:documentation>
    </xs:annotation>
    <xs:simpleType>
      <xs:restriction base="xs:integer">
        ...
        <xs:complexType>
          <xs:sequence>
            ...
            <xs:element ref="Description">
              <xs:annotation>
                <xs:documentation>
                  Descrição da linha de documento
                </xs:documentation>
              </xs:annotation>
            </xs:element>
            <xs:element name="DebitAmount" type="SAFmonetaryType">
      ...
      <xs:element name="CreditLine">
        ...
        <xs:complexType>
          <xs:sequence>
            ...
            <xs:element ref="Description">
              <xs:annotation>
                <xs:documentation>Descrição da linha de documento</xs:documentation>
              </xs:annotation>
            </xs:element>
            <xs:element name="CreditAmount" type="SAFmonetaryType">
              <xs:annotation>
  ...
  <xs:simpleType name="SAFAOProductID">
    <xs:annotation>
      <xs:documentation>
        ...
        Deve ser indicado o nome comercial do software e da empresa empresa produtora no formato 
